...
public class NewsSubscriptionAgency {
    ...
    public static void main(String[] args) {
        ...
        newsAgency.newsUpdate("[Weather] Severe storms forecasted to hit the region, prompting residents to prepare for heavy rainfall and potential flooding");
    ...
    public static void function(Integer userNumber, String name, List<Subscriber> subsList){
        ...
        switch (services){
            ...
            case 2:
                ...
                if(cat == 1){
                    System.out.println();
                    newsAgency.publishNews("\t\t10:30 PM: Quezon City hit by major power outage. Emergency services activated. Stay indoors, use flashlights. Investigation underway. Updates to follow.");
                    newsAgency.unsub(selectedSubscriber);
                    ...
                    newsAgency.publishNews("\t\t10:30 PM: Quezon City hit by major power outage. Emergency services activated. Stay indoors, use flashlights. Investigation underway. Updates to follow.");
                    newsAgency.unsub(selectedSubscriber);
                    System.out.println("\n\t"+name+" received breaking news: \t[Health] Breakthrough study reveals a promising new treatment for a rare genetic disorder, offering hope for affected patients.");
                    newsAgency.newsUpdate("\t\t[Weather] Severe storms forecasted to hit the region, prompting residents to prepare for heavy rainfall and potential flooding");
                    newsAgency.sub(selectedSubscriber);
